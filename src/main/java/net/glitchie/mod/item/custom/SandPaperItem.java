package net.glitchie.mod.item.custom;
...
public class SandPaperItem extends Item {
    ...
    public ActionResult useOnBlock(ItemUsageContext context) {
        ...
        if(SANDPAPER_MAP.containsKey(clickedBlock)) {
            if(!world.isClient()) {
                world.setBlockState(context.getBlockPos(), SANDPAPER_MAP.get(clickedBlock).getDefaultState());
